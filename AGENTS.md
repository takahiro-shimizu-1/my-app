...
This project is indexed by GitNexus as **my-app** (224 symbols, 513 relationships, 20 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
